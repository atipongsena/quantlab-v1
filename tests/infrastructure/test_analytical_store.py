...
from quantlab.infrastructure.analytical_store import AnalyticalQueryError, LocalAnalyticalStore
from quantlab.infrastructure.partitions import read_partition, write_partition


def test_partition_write_and_roundtrip(tmp_path: Path) -> None:
    rows = [
